...
\begin{itemize}
	...
	\item If a pre-defined quorum of users supports the nomination the project references will be turned into copies of the original risk and the original risk will be removed from the risk pool, while the copies remain as project risks for the individual projects.
\end{itemize}
...
The changes are instantly reflected in the database. The voting process is tracked there. Once the changes are confirmed corresponding updates in the database will be triggered by the backend.
\newpage
