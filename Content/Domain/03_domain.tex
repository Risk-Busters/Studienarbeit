...
The creation of necessary tables and relations is being done automatically by the technologies within the Starter-Data-\uc{JPA} module. For further information about the Starter-Data-\uc{JPA} module see chapter \ref{sec:DomainCc}.
