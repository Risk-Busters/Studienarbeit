...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		There are two types how a user can be involved: cognitive or affective. \cite[p. 3030]{hamariDoesGamificationWork2014} Cognitive involvement describes ... -> möglichst viel lernen durch die application
		Affective involvement -> bestimmte Gefühle entwickeln im Bezug auf die Application
